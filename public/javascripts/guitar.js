class Guitar {
  ...
  constructor(guitarCanv = document.getElementById('guitar-canvas'),
              stringsCanv = document.getElementById('strings-canvas'),
              infoCanv = document.getElementById('info-canvas')) {
  ...
  drawGuitar(strings = [0, 1, 2, 3, 4, 5]) {
    ...
    if (this.__sounds.length < 7) {
      for (let i = 0; i < 45; i++) {
        this.__sounds[i] = new Sound(`../sounds/${i}.mp3`);
      }
    }
  ...
  drawSoundBoard() {
    return new Promise((resolve) => {
      ...
      if (this.__soundBoardTexture === null) {
        ...
        this.__soundBoardTexture.src = '../textures/red-oak.jpg';
  ...
  drawFingerBoard() {
    return new Promise((resolve) => {
      ...
      if (this.__fingerBoardTexture === null) {
        ...
        this.__fingerBoardTexture.src = '../textures/black-wood.jpg';
...
window.guitar = new Guitar();
window.guitar.drawGuitar();
